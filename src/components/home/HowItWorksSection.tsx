        ...
        <div className="max-w-5xl mx-auto mt-16">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between relative">
            {steps.map((step, index) => {
              ...
              return (
                <div key={index} className="flex-1 text-center relative px-6 mb-12 md:mb-0">
                  {/* Step number watermark */}
                  <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-4 text-6xl md:text-7xl font-bold text-brand-orange/10 select-none pointer-events-none">
                    {index + 1}
                  </div>
                  
                  {/* Icon container */}
                  <div className="w-16 h-16 rounded-2xl bg-brand-orange flex items-center justify-center mx-auto mt-4 shadow-lg shadow-orange-500/20 relative z-10">
