      ...
      <section className="py-12 bg-background">
        <div className="max-w-4xl mx-auto px-4 space-y-10">
              ...
              {resultadoTela && (() => {
                ...
                return (
                  <div className="mt-2 space-y-4">
                    ...
                    {/* CTA WhatsApp */}
                    <a
                      href={`https://wa.me/556299247285?text=${whatsappMsgTela}`}
                      target="_blank"
          ...
          <div className="bg-brand-orange rounded-2xl p-8 text-center">
            ...
            <a
              href="https://wa.me/556299247285?text=%5Bsrc%3Acalculadora%5D%20Ol%C3%A1!%20Usei%20a%20calculadora%20do%20site%20e%20gostaria%20de%20solicitar%20um%20or%C3%A7amento%20de%20vergalh%C3%A3o."
              target="_blank"
              rel="noopener noreferrer"
