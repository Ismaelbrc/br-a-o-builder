              ...
              {resultadoTela && telaSel && (
                <>
                  ...
                  <div className="mt-8 rounded-xl bg-brand-navy p-6">
                    ...
                    <a
                      href={`https://wa.me/556299032023?text=${whatsappMsgTela}`}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="relative overflow-hidden bg-brand-orange rounded-2xl p-10 md:p-14 text-center">
            ...
            <div className="relative">
              ...
              <a
                href="https://wa.me/556299032023?text=Ol%C3%A1!%20Usei%20a%20calculadora%20do%20site%20e%20gostaria%20de%20solicitar%20um%20or%C3%A7amento%20de%20vergalh%C3%A3o."
                target="_blank" rel="noopener noreferrer"
