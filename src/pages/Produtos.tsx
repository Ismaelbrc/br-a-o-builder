...
const ProductSection = ({ product, index }: { product: Product; index: number }) => {
  ...
  const whatsappUrl = `https://wa.me/556291489786?text=${encodeURIComponent(product.whatsappMsg)}`;
  const genericWhatsappUrl = "https://wa.me/556291489786?text=Ol%C3%A1!%20Gostaria%20de%20falar%20com%20um%20especialista.";
...
export default function Produtos() {
  ...
  const whatsappUrl = "https://wa.me/556291489786?text=Ol%C3%A1!%20Gostaria%20de%20saber%20mais%20sobre%20os%20produtos%20BR%20A%C3%A7o.";
