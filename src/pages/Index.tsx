  ...
  return (
    <Layout>
      ...
      >
        ...
        {/* Camada 1: Vídeo de Fundo — em todos os dispositivos. A foto (poster) aparece
            instantânea e o vídeo entra logo em seguida. preload="none" não bloqueia o load inicial. */}
        <video
          autoPlay
          muted
          loop
