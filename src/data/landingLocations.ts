...
const locations: LandingLocation[] = [
  ...
  },
  {
    ...
    uniqueContent: {
      marketContext: 'O Gama teve a maior valorização imobiliária do Distrito Federal nos últimos anos, puxada principalmente pelo Setor Oeste, que virou um dos polos residenciais que mais cresce fora do centro do DF, e pelo Setor Leste, com forte expansão de condomínios fechados. O Setor Central concentra o comércio, enquanto Norte e Sul reúnem as moradias de padrão mais alto. Esse crescimento distribuído por setores gera demanda constante de vergalhão CA-50 e corte e dobra tanto para residências quanto para os condomínios em construção. A BR Aço atende o Gama a partir da fábrica em Aparecida de Goiânia.',
      neighborhoods: ['Setor Oeste', 'Setor Leste', 'Setor Central', 'Setor Norte', 'Setor Sul'],
      route: 'via BR-060, tempo médio de 2h30min',
      buildingTypes: 'residências no Setor Oeste, condomínios fechados no Setor Leste, obras comerciais no Setor Central',
      population: 139_000,
    },
  },
  ...
  region('nucleo-bandeirante','Núcleo Bandeirante',  205),
  {
    ...
    uniqueContent: {
      marketContext: 'Guará é uma das RAs mais consolidadas do DF, dividida entre Guará I e Guará II, com forte presença de condomínios de médio e alto padrão desde 2010. A "Expansão do Guará" (QEs 48 a 58) segue em obra, com cerca de 1.700 casas novas e mais uma centena de imóveis comerciais em construção — crescimento horizontal que soma à verticalização já consolidada nas quadras internas (QI). A BR Aço atende tanto os condomínios verticais quanto os loteamentos da expansão, com vergalhão CA-50/CA-60 e corte e dobra a partir da fábrica em Aparecida de Goiânia.',
      neighborhoods: ['Guará I', 'Guará II', 'QI (Quadras Internas)', 'QE', 'Setor Lúcio Costa', 'Expansão do Guará (QE 48-58)'],
      route: 'via DF-003 (EPTG), tempo médio de 2h35min',
      buildingTypes: 'condomínios verticais de médio/alto padrão e loteamento horizontal em expansão (Expansão do Guará)',
      population: 121_000,
    },
  },
  region('cruzeiro',          'Cruzeiro',            210),
  {
    ...
    uniqueContent: {
      marketContext: 'Santa Maria é dividida em Norte, Sul e Centro, com crescimento recente concentrado no Setor Habitacional Meireles — onde o novo bairro Residencial Fazenda Santa Maria vai abrigar mais de 11 mil pessoas — e no Setor Habitacional Ribeirão (Condomínio Porto Rico), que recebeu investimento recente em infraestrutura. O perfil de obra combina loteamento novo planejado com condomínios residenciais de médio padrão. A BR Aço entrega vergalhão CA-50 e corte e dobra a partir da fábrica em Aparecida de Goiânia.',
      neighborhoods: ['Santa Maria Norte', 'Santa Maria Sul', 'Santa Maria Centro', 'Setor Habitacional Meireles', 'Setor Habitacional Ribeirão'],
      route: 'via BR-060, tempo médio de 2h35min',
      buildingTypes: 'loteamentos planejados novos, condomínios residenciais e obras de infraestrutura em bairros em formação',
      population: 117_000,
    },
  },
  {
  ...
  },
  {
    ...
    uniqueContent: {
      marketContext: 'Recanto das Emas é uma das RAs com maior volume de lotes populares e residenciais em expansão do DF, com projetos habitacionais novos aprovados nas quadras 117/118 e no Residencial Tamanduá. É também uma das regiões com o metro quadrado mais acessível do DF, o que mantém forte o ritmo de autoconstrução e obras de pequeno porte. A BR Aço fornece vergalhão CA-50 e serviço de corte e dobra a partir da fábrica em Aparecida de Goiânia.',
      neighborhoods: ['Quadras 100', 'Quadras 200', 'Quadras 300', 'Quadras 117/118', 'Residencial Tamanduá'],
      route: 'via BR-060, tempo médio de 2h35min',
      buildingTypes: 'residências populares, autoconstrução, loteamentos novos e pequenas ampliações',
      population: 116_000,
    },
  },
