...
const locations: LandingLocation[] = [
  ...
  hood('aparecida-marajó',          'Setor Marajó',           'Aparecida de Goiânia', 'aparecida-de-goiania', 'GO',  7, 'Goiás'),
  ...
  hood('anapolis-calixtolândia',    'Calixtolândia',          'Anápolis', 'anapolis', 'GO', 52, 'Goiás'),
